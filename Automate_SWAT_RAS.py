...
### orig coord: -2189.12979658  706850.469418  112100.870203 858618.469418
#                os.system('C:\OSGeo4W64\OSGeo4W.bat gdalwarp -overwrite -te -2189.12979658  706850.469418  112100.870203 858618.469418 ' + 'SWATprep/FinalOutputs/FloodDepth/' + ftype + r'/' + 'fr' + str(forecasthr).zfill(3) +'.tif' +  r' SWATprep/FinalOutputs/FloodDepth/' + ftype + r'/' + 'f' + str(forecasthr).zfill(3) +'.tif')
...
#                        
    def pushresults(self):
        ...
        #IMERG
        filepath = 'SWATprep/FinalOutputs/IMERGPrecipitation/' + preciptime + r'/f' + preciptime + '.PNG'
        serverpath = 'public_html/houston/data/imergprecipitation/f' +preciptime + '.PNG'
        try:
        ...
        #ASCII IMERG
        filepath = 'SWATprep/FinalOutputs/IMERGPrecipitation/' + preciptime + r'/f' + preciptime + '.asc'
        serverpath = 'public_html/houston/data/imergprecipitation/imergprecip_f' +preciptime + '.asc'
        try:
            scp.put(filepath, serverpath)
            print  "Success: " + filepath
        except:
        ...
        for ftype in ['GFS']:
            for forecasthr in range(0, (self.noforedays)*24+1, 24):
                # Flood Maps
                filepath = 'SWATprep/FinalOutputs/FloodDepth/' + ftype + r'/' + strdate + r'/f' + str(forecasthr).zfill(3) + '.tif'
                serverpath = 'public_html/houston/data/floodmap/' + ftype.lower() + r'/f' + str(forecasthr).zfill(3) + '.tif'
                try:
                    scp.put(filepath, serverpath)
                    print  "Success: " + filepath
                except:
                ...
                # Flood Maps Tiff
                filepath = 'SWATprep/FinalOutputs/FloodDepth/' + ftype + r'/' + strdate + r'/f' + str(forecasthr).zfill(3) + '.PNG'
                serverpath = 'public_html/houston/data/floodmap/' + ftype.lower() + r'/f' + str(forecasthr).zfill(3) + '.PNG'
                try:
                    scp.put(filepath, serverpath)
                    print  "Success: " + filepath
                except:
                ...
                # ASCII flood maps
                filepath = 'SWATprep/FinalOutputs/FloodDepth/' + ftype + r'/' + strdate + r'/f' + str(forecasthr).zfill(3) + '.asc'
                serverpath = 'public_html/houston/data/floodmap/' + ftype.lower() + r'/floodmap_f' + str(forecasthr).zfill(3) + '_' + strdate + '.asc'
                try:
                    scp.put(filepath, serverpath)
                    print  "Success: " + filepath
                except:
                ...
                # Precipitation Maps
                filepath = 'SWATprep/FinalOutputs/' + ftype + r'Precipitation/' + strdate + r'/f' + str(forecasthr).zfill(3) + '.PNG'
                serverpath = 'public_html/houston/data/' + ftype.lower() + r'precipitation/f' + str(forecasthr).zfill(3) + '.PNG'
                try:
                    scp.put(filepath, serverpath)
                    print  "Success: " + filepath
                except:
                ...
                # ASCII Precipitation Maps
                filepath = 'SWATprep/FinalOutputs/' + ftype + r'Precipitation/' + strdate + r'/f' + str(forecasthr).zfill(3) + '.asc'
                serverpath = 'public_html/houston/data/' + ftype.lower() + r'precipitation/gfsprecip_f' + str(forecasthr).zfill(3) + '_' + strdate + '.asc'
                try:
                    scp.put(filepath, serverpath)
                    print  "Success: " + filepath
                except:
            ...
            for fn in os.listdir('SWATprep/FinalOutputs/Inflow/' + ftype + r'/' + strdate + r'/'):
                filepath = 'SWATprep/FinalOutputs/Inflow/' + ftype + r'/' + strdate + r'/' + fn
                serverpath = 'public_html/houston/data/inflow/' + ftype.lower() + r'/' + fn
                try:    
                    scp.put(filepath, serverpath)
                    print  "Success: " + filepath
